...
namespace MWSClientCsRuntime
{
    public class MwsXmlWriter : IMwsWriter
    {
        ...
        public void Write(string name, object value)
        {
            if (value != null)
            {
                ...
                if (typeof(string).GetType().GetTypeInfo().IsAssignableFrom(type.GetTypeInfo()))
                {
                    BeginObject(name, false);
                ...
                else if (typeof(IMwsObject).GetType().GetTypeInfo().IsAssignableFrom(type.GetTypeInfo()))
                {
                    BeginObject(name, false);
                    ((IMwsObject)value).WriteFragmentTo(this);
                    EndObject(name, false);
                }
                else if (typeof(ICollection).GetType().GetTypeInfo().IsAssignableFrom(type.GetTypeInfo()))
                {
                ...
                else if (typeof(XNode).GetType().GetTypeInfo().IsAssignableFrom(type.GetTypeInfo()))
                {
    ...
    {
        public static string OuterXml(this XElement node)
        {
